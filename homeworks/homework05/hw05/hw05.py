class VendingMachine:
    ...
    def restock(self,cnt):
        self.restock_cnt += cnt
        return "Current {0} stock: {1}".format(self.product,self.restock_cnt)
    
    def add_funds(self,amount):
        if self.restock_cnt <= 0:
    ...
    def vend(self):
        ...
        tmp = self.funds
        self.funds = 0
        return "Here is your {0} and ${1} change.".format(self.product,tmp - self.price) if tmp - self.price > 0 else "Here is your {0}.".format(self.product)
